...
def wavelet_reconstruct(y, wavelet='db4', level=None, reconstruct_levels='1,2'):
    reconstruct_levels = [int(l.strip()) for l in str(reconstruct_levels).split(',')]
...
class wavelet_reconstruct_step(BaseStep):
    ...
    category = "Wavelet"
    description = "Reconstructs a signal from specific wavelet levels."
    tags = ["time-series"]
    params = [
        ...
        { "name": "reconstruct_levels", "type": "str", "default": "1,2", "help": "Comma-separated levels to keep or reconstruct" },
    ...
    def apply(cls, channel: Channel, params: dict) -> Channel:
        params = cls._inject_fs_if_needed(channel, params, wavelet_reconstruct)
        y_new = wavelet_reconstruct(channel.ydata, **params)
