...
def highpass_bessel(y, fs, cutoff=0.5, order=2):
...
class highpass_bessel_step(BaseStep):
    ...
    category = "Filter"
    description = "Applies a high-pass Bessel filter to the signal (preserves waveform shape)."
    tags = ["time-series"]
    params = [
    ...
    def apply(cls, channel: Channel, params: dict) -> Channel:
        ...
        params = cls._inject_fs_if_needed(channel, params, highpass_bessel)
        y_new = highpass_bessel(y, **params)
