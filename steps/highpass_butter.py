...
def highpass_butter(y, fs, cutoff=0.5, order=2):
...
class highpass_butter_step(BaseStep):
    ...
    category = "Filter"
    description = "Applies a high-pass Butterworth filter to the signal (flat frequency response)."
    tags = ["time-series"]
    params = [
    ...
    def apply(cls, channel: Channel, params: dict) -> Channel:
        ...
        params = cls._inject_fs_if_needed(channel, params, highpass_butter)
        y_new = highpass_butter(y, **params)
