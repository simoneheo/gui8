...
def bandpass_butter(y, fs, cutoff=(0.5, 4.0), order=2):
    ...
    try:
        ...
        if "padlen" in str(e):
            ...
            msg = (
                f"Signal too short for Butterworth bandpass filter: "
...
class bandpass_butter_step(BaseStep):
    ...
    category = "Filter"
    description = "Applies a band-pass Butterworth filter to the signal (flat frequency response)."
    tags = ["time-series"]
    params = [
    ...
    def apply(cls, channel: Channel, params: dict) -> Channel:
        ...
        params = cls._inject_fs_if_needed(channel, params, bandpass_butter)
        y_new = bandpass_butter(y, **params)
